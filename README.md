...
Connect your ERPNext site directly to your **WhatsJet SaaS** instance and automate your customer communications instantly.
...
- ✅ **WhatsJet Integration**: Seamlessly connects to your custom WhatsJet SaaS domain.
...
1. **Get your API Credentials**:
   - Log in to your WhatsJet SaaS dashboard (e.g., `https://wasender.digitalsoftech.com`).
...
For support, please contact [support@nexgenerp.com](mailto:support@nexgenerp.com) or visit [nexgenerp.com](https://nexgenerp.com).

*Built with ❤️ by NexGen ERP Technologies*
